...
//
// Check out https://github.com/dailab/libsml for libsml.
...
int main(int argc, char **argv) {
	// this example assumes that a ED300L meter sending SML messages via a
